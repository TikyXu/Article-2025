...
class TrainerSupernet:
    ...
    def __init__(self, device_dis, device_gen, logger, writer, run_time, lookup_table, class_number_count):
        ...
        self.best_generator_for_generator = None # Discriminator最高Accuracy子网络，用于验证Generator生成准确率
    ...
    def train_loop(self, train_loader, test_loader, generator_supernet, discriminator_supernet):
        ...
        discriminator_supernet = torch.load('./models/2025-07-28 02:27:14.800098/Discriminator/Supernet/Final_Discriminator_Supernet.pth',
                                            weights_only=False, ).to(self.device_dis)
        ...
        # TopK采样
        k = 2
        for i in range(int(self.sample_number)-1):
            # 采样TopK个体,且规避重复
            while True:
                final_topk_discriminator, final_topk_discriminator_latency, final_topk_discriminator_code = self._sample(discriminator_supernet, mode='TopK', k=3)
